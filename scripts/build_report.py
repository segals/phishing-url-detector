...
P("Phishing remains a leading initial-access vector, and much of it is carried entirely by a malicious "
  ...
  "ablation, we show this score is driven overwhelmingly by a dataset collection artifact "
  "(legitimate URLs in this corpus are 100% HTTPS versus 48.6% for phishing) rather than by a "
  "transferable "
...
P("On the adversarial side, Boucher <i>et&nbsp;al.</i>&nbsp;[6] document imperceptible-perturbation "
  "attacks against text-processing and web-facing systems, including homoglyph substitution "
  "(visually identical characters from other Unicode scripts), motivating both the homoglyph attack "
  "and the "
...
P("Two families rest on explicit theory. <b>Entropy</b> features use the Shannon entropy of a string, "
  # NB: use ReportLab's <sub> markup, never a Unicode subscript character -- the built-in
  # Type-1 fonts have no glyph for U+2082 and render it as a solid black box.
  "H(s)&nbsp;=&nbsp;&minus;&Sigma;<sub>i</sub>&nbsp;p<sub>i</sub>&nbsp;log<sub>2</sub>&nbsp;p<sub>i</sub>, "
...
P("An AUC below 0.5 reflects this precisely: within that saturated band benign URLs are on average "
  ...
  "single feature. Recall on the <b>live OpenPhish</b> feed nevertheless remains 1.00: present-day phishing "
...
P("Together these support a methodological conclusion: for URL-based phishing detection, "
  ...
  "results rather than optional robustness checks. The companion content-based detector, built "
